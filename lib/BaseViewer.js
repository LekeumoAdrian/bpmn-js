 ...
 * @typedef {import('./BaseViewer').ModelElement} ModelElement
 ...
 * @param {ModelElement|string} [bpmnDiagram] The optional diagram or Id of the BPMN diagram to open.
 *
...
BaseViewer.prototype.importXML = wrapForCompatibility(async function importXML(xml, bpmnDiagram) {
  ...
  try {
     ...
     * @type {Object}
     * @property {Error|null} error An error thrown during parsing the XML.
     * @property {ModdleElement} definitions The definitions.
     * @property {Map<string, ModelElement>} elementsById The model elements by ID.
     * @property {ModdleElement[]} references The references.
...
BaseViewer.prototype.saveXML = wrapForCompatibility(async function saveXML(options) {
   ...
   * @type {Object}
   * @property {Error} [error] An error thrown during export.
   * @property {string} [xml] The XML.
   */
 ...
 *
 * @returns {ModelElement} The definitions model element.
 */
 ...
 *
 * @param {ModelElement<Definitions>} definitions
 * @param {string} diagramId
 *
 * @return {ModelElement<BPMNDiagram>|null}
 */
