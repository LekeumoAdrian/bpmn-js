...
export type BaseViewerOptions = {
  ...
  moddleExtensions?: Map<string, ModdleExtension>;
...
export default class BaseViewer extends Diagram {
   ...
   */
  importXML(xml: string, bpmnDiagram?: ModelElement | string): Promise<ImportXMLResult>;
   ...
   * @return A promise resolving with warnings that were produced during the import.
   */
  importDefinitions(definitions: ModelElement, bpmnDiagram?: ModelElement | string): Promise<ImportDefinitionsResult>;
   ...
   */
  open(bpmnDiagramOrId: ModelElement | string): Promise<OpenResult>;
